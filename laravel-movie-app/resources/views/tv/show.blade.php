...
@section('content')
    ...
    <div class="tv-info">   <!-- Tv-Info-Start -->
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
                ...
                <div class="md:ml-24">
                    ...
                    <div class="flex flex-wrap items-center text-gray-600 text-sm">
                        <span id="rating" class="tv-details  text-gray-600">
                        ...
                        <div class="mt-12">
                            ...
                            <div class="flex mt-4 text-gray-600">
                                @foreach ($tvshow['featuredCast'] as $cast)
                                        <div class="mr-8">
                                            <div>{{ $cast['name'] }}</div>
                                         </div>
                                @endforeach
                        ...
                        <div x-data="{ isOpen: false }">
                            ...
                            @if (count($tvshow['videos']['results']) > 0)
                                <div class="mt-12">
                                    <button
                                        @click="isOpen = true"
                                        class="inline-flex items-center bg-teal-400 text-white rounded font-semibold px-5 py-4 hover:bg-teal-600 transition ease-in-out duration-150">
    ...
    <!-- cast-start -->
    <div class="tv-cast border-b border-t border-teal-400">
    ...
    <!-- tv-seasons-start -->
    <div class="tv-seasons border-b border-t border-teal-400">
        <div class="container mx-auto px-4 py-16">
            <h2 class="text-4xl font-semibold">Cast</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 pl-1 pr-3">
             <!-- Dynamic Content from IMDB APi -->
    ...
    <!-- tv images-start -->
    <div class="tv-images border-b border-teal-400" x-data="{ isOpen: false, image: ''}">
        <div class="container mx-auto px-4 py-16">
                ...
                @foreach ($tvshow['images'] as $image)
                    <div class="mt-8">
                        <a href="#"
                            ...
                            <img src="{{ 'https://image.tmdb.org/t/p/w500/'.$image['file_path']  }}" alt="tv-image" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>
                    </div>
                @endforeach
            </div>
