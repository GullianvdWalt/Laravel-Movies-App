        ...
        <div class="my-1 px-1 lg:my-6">
            ...
            <article class="overflow-hidden rounded-lg shadow-lg h-full">
                ...
                <a href="{{ route('tv.show', $tvshow['id']) }}">
                    <img alt="Placeholder" class="block h-auto w-72 hover:opacity-75 transition ease-in-out duration-150" src="{{ $tvshow['poster_path']  }}">
                </a>

            <div class="mt-2 p-4 flex flex-col text-center">
                    <a href="" class="text-lg mt-2 hover:text-gray-700">{{ $tvshow['name'] }}</a>
                    <div class="flex items-center justify-center text-gray-600 my-3">
                        ...
                        <span class="ml-1" class="tv-details" id="percentage">{{ $tvshow['vote_average'] }}</span>
                        <span class="mx-2" class="tv-details">|</span>
                        <span id="releaseDate" class="tv-details">{{ $tvshow['first_air_date'] }}</span>
                    </div>
                    <div class="text-gray-600 text-sm tv-details" id="genre">{{ $tvshow['genres'] }}</div>
                </div>
